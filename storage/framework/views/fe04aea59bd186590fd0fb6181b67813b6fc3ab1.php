                ...
                <table id="sale-table" class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e(number_format((float)($sale->grand_total - $sale->paid_amount), 0, '.', '.')); ?></td>
                ...
                <table id="purchase-table" class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e(number_format((float)($purchase->grand_total - $purchase->paid_amount), 0, '.', '.')); ?></td>
                ...
                <table id="return-table" class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e(number_format((float)($return->grand_total), 0, '.', '.')); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                    <tfoot class="tfoot active">
