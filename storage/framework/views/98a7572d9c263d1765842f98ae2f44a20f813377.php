        ...
        <table id="account-table" class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo e(number_format((float)$credit[$key], 0, '.', '.')); ?></td>
                    <td><?php echo e(number_format((float)($debit[$key] * -1), 0, '.', '.')); ?></td>
                    <td><?php echo e(number_format((float)($credit[$key] - $debit[$key]), 0, '.', '.')); ?></td>
                </tr>
